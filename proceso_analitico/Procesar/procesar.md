...
- [Procesamiento: Conjunto de datos de Cyclistyc](#procesamiento-conjunto-de-datos-de-cyclistyc)
- [Índice](#índice)
  - [Objetivo](#objetivo)
  ...
  - [Limpieza de los datos](#limpieza-de-los-datos)
    - [Verificar tipos de datos](#verificar-tipos-de-datos)
      - [Paso 1: Creación de la Lista de Tipos de Datos](#paso-1-creación-de-la-lista-de-tipos-de-datos)
      - [Paso 2: Comparación de Tipos de datos](#paso-2-comparación-de-tipos-de-datos)
      - [Paso 3: Unificar tipos de datos](#paso-3-unificar-tipos-de-datos)
    ...
    - [Obtenemos la duracion del viaje](#obtenemos-la-duracion-del-viaje)
    - [Verificar consistencia de los datos](#verificar-consistencia-de-los-datos)
    - [Verificamos consistencia de los datos](#verificamos-consistencia-de-los-datos)
    - [Verificamos categorias existentes en las variables](#verificamos-categorias-existentes-en-las-variables)
    ...
    - [Almacenamos nuestro conjunto de datos final](#almacenamos-nuestro-conjunto-de-datos-final)
...
![Tibble de `conjunto_datos` 1](https://github.com/alabacw74/analisis-datos-bicicletas-compartidas/blob/main/proceso_analitico/Procesar/images/tibble_conjunto_datos_01.png)

![Tibble de `conjunto_datos` 2](https://github.com/alabacw74/analisis-datos-bicicletas-compartidas/blob/main/proceso_analitico/Procesar/images/tibble_conjunto_datos_02.png)
