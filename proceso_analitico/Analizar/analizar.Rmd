...
# Crear el gráfico circular con porcentajes (usando ggplot2)
library(ggplot2)
pie_chart <- ggplot(data = conteo_tipo_usuario, aes(x = "", y = count, fill = member_casual)) +
  geom_bar(stat = "identity", width = 1, color = "white") +
  coord_polar("y") +
  theme_void() +
  scale_fill_manual(values = colores) +
  labs(title = "Porcentaje de cada tipo de usuario", sub = "Subtítulo aquí")

# Guardar el gráfico
ggsave("pie_chart.png", pie_chart, width = 6, height = 6, units = "in")
...
```{r}
ggplot(data=tipo_bicicleta_por_tipo_usuario) +
